...
def get_weather():
  ...
  return weather['weather'],math.floor(weather['high']),math.floor(weather['low']),weather['date'],weather['city']
...
wea, temperature_high,temperature_low,d,city = get_weather()
...
print(res)
template_id1 = os.environ["LIHEXU"]
res1 = wm.send_template(user_id, template_id1, data)
print(res1)
